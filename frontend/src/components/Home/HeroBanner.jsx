...
const HeroBanner = () => {
  ...
  return (
    <section className="relative min-h-screen bg-linear-to-br from-amber-50 via-orange-50 to-yellow-50 overflow-hidden">
      {/* Background Pattern */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <button
                onClick={() => navigate("/all-loans-options")}
                className="group bg-white hover:bg-gray-50 text-gray-900 font-semibold px-8 py-4 rounded-xl border-2 border-gray-200 hover:border-primary/30 transition-all duration-300 flex items-center justify-center"
              >
          ...
          >
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600">Trusted by thousands nationwide</p>
              </div>
